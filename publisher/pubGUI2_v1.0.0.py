#!/usr/bin/env python3
import os, json, asyncio, threading, logging, sys, datetime
from autobahn.asyncio.wamp import ApplicationSession, ApplicationRunner

if sys.platform.startswith('win'):
    asyncio.set_event_loop_policy(asyncio.WindowsSelectorEventLoopPolicy())

# Configurar el logger para mensajes publicados:
LOG_FILENAME = os.path.join(os.getcwd(), "log" + datetime.datetime.now().strftime("%Y-%m-%d_%H") + ".txt")

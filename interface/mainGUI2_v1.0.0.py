...
# Agregar la carpeta raíz del proyecto al sys.path (ajusta según tu estructura)
...
class PublisherEditorWidget(QWidget):
    ...
    def initUI(self):
        ...
        # Botón común para importar JSON (arriba)
        ...
        self.jsonEditor.hide()  # Inicia en modo Formulario Dinámico
